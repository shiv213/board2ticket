...
echo "python ./track/track_viewer.py --video $VIDEO_PATH"
echo ""
echo "To view white pixel timeline:"
echo "python ./tracktrack_viewer.py --mode timeline"
